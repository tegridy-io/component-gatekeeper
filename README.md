# Commodore Component: OPA Gatekeeper

This is a [Commodore][commodore] Component for OPA Gatekeeper.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/gatekeeper).
